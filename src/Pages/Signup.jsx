      ...
      <div className="h-[100dvh] flex my-10">
        ...
        <div className="flex-1 flex flex-col justify-center px-8 lg:py-8 lg:px-16 xl:px-24">
          <div className="w-full max-w-md mx-auto">
            ...
            {/* <!-- Form Header --> */}
            <div className="mb-8">
              <h1 className="text-4xl font-bold text-gray-900 mb-5">Create an Account</h1>
              <p className="text-gray-600 mb-2">Never lose track of an item again.</p>
            </div>
            ...
            <form id="signupForm" className="space-y-6">
              ...
              <div className="">
                <button type="button" className="w-full flex justify-center items-center py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors duration-200">
